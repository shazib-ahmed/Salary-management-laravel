                    ...
                    <div class="form-group">
                        ...
                        <select name="player_id" class="form-control" id="player">
                            @foreach($players as $id => $player)
                                <option {{ $id == $salary->player->id ? 'selected' : null }} value="{{ $id }}">{{ $player }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="season_id" class="form-control" id="season">
                            @foreach($seasons as $id => $season)
                                <option {{ $id == $salary->season->id ? 'selected' : null }} value="{{ $id }}">{{ $season }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="salary">{{ __('salary') }}</label>
                        <input type="number" class="form-control" id="salary" placeholder="{{ __('salary') }}" name="salary" value="{{ old('salary', $salary->salary) }}" />
                    </div>
